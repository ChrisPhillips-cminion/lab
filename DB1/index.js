...
let books = [{
  ...
  "description": "<br><p>The book is set in a fictional world where computer systems have become increasingly advanced and autonomous, but they still seem to have some wacky quirks and mysteries. The protagonist, a young woman named Fried, is tasked with investigating a mysterious computer system called the Fried API.As she explores the Fried API, she meets various characters from different fields, including a scientist who has a soft spot for her, a hacker who is always on the run, and a mad scientist who wants to destroy everything he touches. </p><br><p>Along the way, Fried discovers that the Fried API is not just another computer system, but rather a complex and interconnected network of artificial intelligence systems that work together to achieve their goals.Throughout the book, Fried learns about the complexities of AI systems and how they interact with each other. She also encounters various challenges and obstacles as she navigates the Fried API's vast and dangerous landscape. Overall, 'Fried API: A Comical Journey Through the Wacky World of Computer AI' is a captivating and thought-provoking exploration of the wacky world of computer AI. It offers a unique and engaging read that will surely captivate the reader's imagination.</p>",
  "genre": "Fantasy",
  ...
  "genre": "Fantasy",
  "description": "<br><p>In the small town of Bull City, Pennsylvania, a young girl named Lily is sent to live with her grandmother, who has been missing for several years. When Lily arrives, she discovers that her grandmother is actually a powerful wizard, and that she has inherited a magical tequila drink that can heal wounds and even cure illnesses. But when Lily starts dating a mysterious stranger, things get even more strange and Lily soon realizes that her grandmother is far more sinister than she first thought.</p><br><p> With the help of her friends and family, Lily must navigate the complex world of magic and come to terms with her own dark side.</p>",
