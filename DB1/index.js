...
let books = [{
  ...
  "genre": "Fantasy",
  "description": "<p>In the small town of Bull City, Pennsylvania, a young girl named Lily is sent to live with her grandmother, who has been missing for several years. When Lily arrives, she discovers that her grandmother is actually a powerful wizard, and that she has inherited a magical tequila drink that can heal wounds and even cure illnesses. But when Lily starts dating a mysterious stranger, things get even more strange and Lily soon realizes that her grandmother is far more sinister than she first thought.</p><p> With the help of her friends and family, Lily must navigate the complex world of magic and come to terms with her own dark side.</p>",
